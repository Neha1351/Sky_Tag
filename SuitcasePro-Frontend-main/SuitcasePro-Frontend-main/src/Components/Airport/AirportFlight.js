...
const AirportFlight = () => {
  ...
  useEffect(() => {
    axiosInstance
      .post(`/viewAirportFlights/${localStorage.getItem("airportauthoritylogid")}`)
      .then((res) => {
        console.log(res, "show flights");
        setfdata(res.data.airportFlights);
      })
      .catch((err) => {
        console.log(err);
      });
          ...
          <div className="container">
            ...
            <div className="row justify-content-center">
                <div className="col-md-6 text-center mb-5">
                  <h2 className="heading-section">Flights Scheduled</h2>
                </div>
              </div>
